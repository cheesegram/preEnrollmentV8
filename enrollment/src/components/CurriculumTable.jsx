        ...
        {yearKeys.map((year, idx) => {
          ...
          return (
            <button
              ...
              className={`px-4 sm:px-6 py-2.5 rounded-xl text-xs sm:text-sm font-bold tracking-wide uppercase transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2E522A] cursor-pointer hover:-translate-y-0.5 ${isActive
